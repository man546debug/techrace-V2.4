...
class MainActivity : Activity() {
    ...
    private fun showConfig() {
        val items = arrayOf(
            ...
            "Ler uma vez", "Desconectar USB", "Sobre a V2.4", "Consultar módulo / EEPROM", "Exportar telemetria CSV", "Limpar histórico CSV"
        )
        AlertDialog.Builder(this).setTitle("Configurações / Settings").setItems(items) { _, index ->
            when (index) {
                ...
                5 -> AlertDialog.Builder(this).setTitle("TechRace V2.4 — USB + programação")
